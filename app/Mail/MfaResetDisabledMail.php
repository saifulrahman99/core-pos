...
class MfaResetDisabledMail extends Mailable
{
                        ...
                        <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="max-width: 480px; background-color: #ffffff; border-radius: 12px; box-shadow: 0 1px 3px 0 rgba(0, 0, 0, 0.1); overflow: hidden;">
                            ...
                            <tr>
                                <td style="padding: 32px 40px;">
                                    <h2 style="margin: 0 0 24px; font-size: 18px; font-weight: 600; color: #0f172a; letter-spacing: -0.025em;">Two-Factor Authentication Disabled</h2>

                                    <p style="margin: 0 0 16px; font-size: 15px; line-height: 1.6; color: #475569;">Hello {$userName},</p>

                                    <p style="margin: 0 0 16px; font-size: 15px; line-height: 1.6; color: #475569;">Your two-factor authentication for <strong style="color: #0f172a;">{$appName}</strong> has been successfully disabled.</p>
                                        ...
                                        <tr>
                                            <td style="padding: 16px;">
                                                <p style="margin: 0; font-size: 13px; line-height: 1.5; color: #991b1b;">
                                                    <strong>Security Alert:</strong> If you did not request this change, please contact your administrator immediately and re-enable MFA to secure your account.
                                                </p>
                                            </td>
                                        </tr>
                                    </table>
